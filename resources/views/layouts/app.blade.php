...
<aside class="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        @php $biodataOpen = request()->routeIs('siswa.*','guru.*','kepsek-user.*','admin.index','admin.create','admin.edit','admin.update','admin.akun.*'); @endphp
        ...
        <div class="submenu {{ $biodataOpen ? 'open' : '' }}" id="biodata">
            <a href="{{ route('siswa.index') }}" class="menu-item {{ request()->routeIs('siswa.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Data Siswa
            </a>
            <a href="{{ route('guru.index') }}" class="menu-item {{ request()->routeIs('guru.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Data Guru
            </a>
            <a href="{{ route('kepsek-user.index') }}" class="menu-item {{ request()->routeIs('kepsek-user.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Kepala Sekolah
            </a>
            <a href="{{ route('admin.index') }}" class="menu-item {{ request()->routeIs('admin.index') || request()->routeIs('admin.create') || request()->routeIs('admin.edit') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Data Admin
            </a>
        ...
        <button class="menu-item menu-toggle {{ $adminOpen ? 'open' : '' }}" onclick="toggleMenu(this, 'admin-menu')">
            <i class="fa fa-cogs icon"></i> Administrasi
            <i class="fa fa-chevron-down menu-arrow"></i>
        </button>
        <div class="submenu {{ $adminOpen ? 'open' : '' }}" id="admin-menu">
            <a href="{{ route('tapel.index') }}" class="menu-item {{ request()->routeIs('tapel.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Tahun Pelajaran
            </a>
            <a href="{{ route('kelas.index') }}" class="menu-item {{ request()->routeIs('kelas.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Data Kelas
            </a>
            <a href="{{ route('mapel.index') }}" class="menu-item {{ request()->routeIs('mapel.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Data Mapel
            </a>
        </div>

        @php $penilaianOpen = request()->routeIs('pembelajaran.*'); @endphp
        <button class="menu-item menu-toggle {{ $penilaianOpen ? 'open' : '' }}" onclick="toggleMenu(this, 'penilaian-menu')">
            <i class="fa fa-star icon"></i> Penilaian
            <i class="fa fa-chevron-down menu-arrow"></i>
        </button>
        <div class="submenu {{ $penilaianOpen ? 'open' : '' }}" id="penilaian-menu">
            <a href="{{ route('pembelajaran.index') }}" class="menu-item {{ request()->routeIs('pembelajaran.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Pembelajaran
            </a>
        </div>
