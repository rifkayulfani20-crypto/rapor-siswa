...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        @php $waliOpen = request()->routeIs('guru.walikelas.*'); @endphp
        <button class="menu-item menu-toggle {{ $waliOpen ? 'open' : '' }}" onclick="toggleMenu(this, 'walikelas')">
            <i class="fa fa-chalkboard-teacher icon"></i> Wali Kelas
            <i class="fa fa-chevron-down menu-arrow"></i>
        </button>
        <div class="submenu {{ $waliOpen ? 'open' : '' }}" id="walikelas">
            ...
            <a href="{{ route('guru.walikelas.nilaiSosial') }}" class="menu-item {{ request()->routeIs('guru.walikelas.nilaiSosial*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Input Nilai Sosial
            </a>
            <a href="{{ route('guru.walikelas.nilaiSpiritual') }}" class="menu-item {{ request()->routeIs('guru.walikelas.nilaiSpiritual*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Input Nilai Spiritual
            </a>
            <a href="{{ route('guru.walikelas.ketidakhadiran') }}" class="menu-item {{ request()->routeIs('guru.walikelas.ketidakhadiran*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Input Ketidakhadiran
            </a>
        </div>

        @php $mapelOpen = request()->routeIs('guru.mapel.*'); @endphp
        <button class="menu-item menu-toggle {{ $mapelOpen ? 'open' : '' }}" onclick="toggleMenu(this, 'mapel')">
            <i class="fa fa-book icon"></i> Guru Mapel
            <i class="fa fa-chevron-down menu-arrow"></i>
        </button>
        <div class="submenu {{ $mapelOpen ? 'open' : '' }}" id="mapel">
            <a href="{{ route('guru.mapel.nilai') }}" class="menu-item {{ request()->routeIs('guru.mapel.*') ? 'active' : '' }}">
                <i class="fa fa-circle icon"></i> Nilai Pelajaran
            </a>
        </div>
