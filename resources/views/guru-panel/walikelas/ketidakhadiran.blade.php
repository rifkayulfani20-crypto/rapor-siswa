...
<div class="page-title">Data Ketidakhadiran</div>
            ...
            <table id="kelasTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guru.walikelas.ketidakhadiran.edit', $kelas->id) }}"
                               class="btn btn-primary btn-sm" title="Input Ketidakhadiran">
