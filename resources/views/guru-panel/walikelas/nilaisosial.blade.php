...
@section('title', 'Data Nilai Sosial')
@section('content')

<div class="page-title">Data Nilai Sosial</div>
            ...
            <table id="kelasTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guru.walikelas.nilaiSosial.edit', $kelas->id) }}"
                               class="btn btn-primary btn-sm" title="Input Nilai Sosial">
