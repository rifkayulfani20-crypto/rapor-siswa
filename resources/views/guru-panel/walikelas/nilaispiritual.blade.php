...
@section('title', 'Data Nilai Spiritual')
@section('content')

<div class="page-title">Data Nilai Spiritual</div>
            ...
            <table id="kelasTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guru.walikelas.nilaiSpiritual.edit', $kelas->id) }}"
                               class="btn btn-primary btn-sm" title="Input Nilai Spiritual">
